...
const CardsSlider: React.FC<ICardsSliderProps> = memo(
  ({
    onClick,
    title,
    subtitle,
    ...
    const skeletonElements = useMemo(() => {
      ...
      return Array.from({ length: totalItemsInView }, (_, index) => {
        if (type === "teams") {
    ...
    }, [isLoading, totalItemsInView, type])

    const displayElements = useMemo(() => {
      return isLoading ? skeletonElements : elements
    }, [isLoading, skeletonElements, elements])
