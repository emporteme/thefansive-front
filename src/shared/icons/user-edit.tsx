...
const UserEdit: React.FC<{ className?: string; fill?: boolean }> = ({ className, fill }) => {
  if (fill) {
    return (
      <svg
        width="20"
      ...
      >
        ...
        />
        <path
          d="M8.75098 10.833C10.1891 10.833 11.5055 11.354 12.5225 12.2168L11.1436 13.5967C10.5517 14.1886 10.1476 14.9432 9.9834 15.7637L9.80273 16.667H2.91797C2.91797 13.4453 5.52932 10.833 8.75098 10.833Z"
          fill="currentColor"
        />
      </svg>
    )
